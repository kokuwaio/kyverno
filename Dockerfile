...
FROM docker.io/library/bash:5.3.20@sha256:f189d1dc8e4329a91abe774c5f0f46b218b77ec5dab42c9abdca86639ddf0261 AS yq
...
FROM docker.io/library/bash:5.3.20@sha256:f189d1dc8e4329a91abe774c5f0f46b218b77ec5dab42c9abdca86639ddf0261 AS kustomize
SHELL ["/usr/local/bin/bash", "-u", "-e", "-c"]
ARG TARGETARCH
...
FROM docker.io/library/bash:5.3.20@sha256:f189d1dc8e4329a91abe774c5f0f46b218b77ec5dab42c9abdca86639ddf0261 AS kyverno
SHELL ["/usr/local/bin/bash", "-u", "-e", "-c"]
ARG TARGETARCH
