...
FROM docker.io/library/bash:5.3.15@sha256:a618323ba606585ce5bc494e982f80fd3801cdeb46194ff278f12a0862bd270a AS yq
...
FROM docker.io/library/bash:5.3.15@sha256:a618323ba606585ce5bc494e982f80fd3801cdeb46194ff278f12a0862bd270a AS kustomize
SHELL ["/usr/local/bin/bash", "-u", "-e", "-c"]
ARG TARGETARCH
...
FROM docker.io/library/bash:5.3.15@sha256:a618323ba606585ce5bc494e982f80fd3801cdeb46194ff278f12a0862bd270a AS kyverno
SHELL ["/usr/local/bin/bash", "-u", "-e", "-c"]
ARG TARGETARCH
