...
FROM docker.io/library/bash:5.3.9@sha256:0260ac35840d4e3cac51ef8ed059dc5dd5e997ed5c90edd8bdb991d507074366 AS yq
...
FROM docker.io/library/bash:5.3.9@sha256:0260ac35840d4e3cac51ef8ed059dc5dd5e997ed5c90edd8bdb991d507074366 AS kustomize
SHELL ["/usr/local/bin/bash", "-u", "-e", "-c"]
ARG TARGETARCH
...
FROM docker.io/library/bash:5.3.9@sha256:0260ac35840d4e3cac51ef8ed059dc5dd5e997ed5c90edd8bdb991d507074366 AS kyverno
SHELL ["/usr/local/bin/bash", "-u", "-e", "-c"]
ARG TARGETARCH
