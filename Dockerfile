...
FROM docker.io/library/bash:5.3.20@sha256:f17265d2cfd0daecf447d68af4770dd55a5d13e64cbf683112ae28bc8bc56665 AS yq
...
FROM docker.io/library/bash:5.3.20@sha256:f17265d2cfd0daecf447d68af4770dd55a5d13e64cbf683112ae28bc8bc56665 AS kustomize
SHELL ["/usr/local/bin/bash", "-u", "-e", "-c"]
ARG TARGETARCH
...
FROM docker.io/library/bash:5.3.20@sha256:f17265d2cfd0daecf447d68af4770dd55a5d13e64cbf683112ae28bc8bc56665 AS kyverno
SHELL ["/usr/local/bin/bash", "-u", "-e", "-c"]
ARG TARGETARCH
