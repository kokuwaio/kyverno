...
FROM docker.io/library/bash:5.3.15@sha256:6d8f51207a15dddc064187ffc09807fa88411d6d4691e88af67276096db67364 AS yq
...
FROM docker.io/library/bash:5.3.15@sha256:6d8f51207a15dddc064187ffc09807fa88411d6d4691e88af67276096db67364 AS kustomize
SHELL ["/usr/local/bin/bash", "-u", "-e", "-c"]
ARG TARGETARCH
...
FROM docker.io/library/bash:5.3.15@sha256:6d8f51207a15dddc064187ffc09807fa88411d6d4691e88af67276096db67364 AS kyverno
SHELL ["/usr/local/bin/bash", "-u", "-e", "-c"]
ARG TARGETARCH
